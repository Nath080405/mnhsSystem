...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('teachers.student') }}" class="btn btn-outline-secondary">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form method="POST" action="{{ route('teacher.student.update', ['id' => $student->id]) }}">
                @csrf
                @method('PUT')
                ...
                <div class="d-flex justify-content-end gap-2 mt-4">
                    <a href="{{ route('teachers.student') }}" class="btn btn-outline-secondary">Cancel</a>
